...
### 4. Kick (<span class="dash-badge kick">KICK</span>)
* The user is immediately removed from the Discord server.
* They receive a direct message about the kick before being removed. They can rejoin the server if they have a valid invite link.
