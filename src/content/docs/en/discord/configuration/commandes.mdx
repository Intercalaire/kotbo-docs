...
* **Mod**: the command requires the member to hold a role defined as moderator in the dashboard, or the Discord *Manage Messages* permission (for example `/sanction warn`).
