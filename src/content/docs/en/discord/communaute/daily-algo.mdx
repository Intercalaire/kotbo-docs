...
:::caution[The dashboard page has been withdrawn]
Daily Algo no longer has a dashboard page: the module and its Discord commands keep working, but challenges can no longer be created or scheduled from the web interface. The publishing channel is still set in the [Management center](/en/dashboard/configuration/centre-gestion/).
:::
