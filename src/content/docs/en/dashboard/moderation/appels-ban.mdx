...
* **Appeal form**: pick the question form. You must create that form beforehand in the **Forms** module (which is where you define your own questions, add your logo or banner and apply your custom CSS).
...
* Marks the request as <span class="dash-badge ban">DENIED_PERMANENT</span>.
...
5. Temporarily marks the request as <span class="dash-badge timeout">NEEDS_INFO</span>.
